...
# 导入ModelScope Image Web节点
try:
    from Modelscope_Node.modelscope_image_web import NODE_CLASS_MAPPINGS as MODELSCOPE_IMAGE_NODE_MAPPINGS
    from Modelscope_Node.modelscope_image_web import NODE_DISPLAY_NAME_MAPPINGS as MODELSCOPE_IMAGE_DISPLAY_MAPPINGS
except ImportError as e:
    print(f"Warning: Failed to import Modelscope_Node.modelscope_image_web: {e}")
...
try:
    ...
    from Hunyuan_Node.hunyuan_image import NODE_DISPLAY_NAME_MAPPINGS as HUNYUAN_IMAGE_DISPLAY_MAPPINGS
except ImportError as e:
    print(f"Warning: Failed to import Hunyuan_Node.hunyuan_image: {e}")
    HUNYUAN_IMAGE_NODE_MAPPINGS = {}
    HUNYUAN_IMAGE_DISPLAY_MAPPINGS = {}
...
# 导入Translate - 翻译节点
try:
    from Translate_Node.free_translate import NODE_CLASS_MAPPINGS as FREE_TRANSLATE_NODE_MAPPINGS
    from Translate_Node.free_translate import NODE_DISPLAY_NAME_MAPPINGS as FREE_TRANSLATE_DISPLAY_MAPPINGS
except ImportError as e:
    print(f"Warning: Failed to import Translate_Node.free_translate: {e}")
